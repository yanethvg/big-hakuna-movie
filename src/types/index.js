...
export const COMENZAR_DESCARGA_PELICULA = 'COMENZAR_DESCARGA_PELICULAS_ALL';
export const DESCARGA_PELICULA_EXITOSA = 'DESCARGA_PELICULAS_EXITOSA_ALL';
export const DESCARGA_PELICULA_ERROR = 'DESCARGA_PELICULAS_ERROR_ALL';
